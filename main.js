...
console.log(userObj);
document.write(userObj.firstName + '<br>' + userObj.lastName + '<br>' + userObj.age  + '<br>' + '<br>');
...
document.write(userObj.fullName() + '<br>' + '<br>');
...
document.write(defUpperStr('My text') + '<br>');
document.write(defUpperStr() + '<br>' + '<br>');
...
document.write(evenFn(10) + '<br>');
document.write(evenFn(15) + '<br>');
document.write(evenFn(20) + '<br>' + '<br>');
...
document.write(weekFn(1) + '<br>');
document.write(weekFn(3) + '<br>');
document.write(weekFn(7) + '<br>');
document.write(weekFn(9) + '<br>');
document.write(weekFn(1.5) + '<br>');
document.write(weekFn('2') + '<br>' + '<br>');
...
document.write('    -1 :', ageClassification(-1) + '<br>');
document.write('     0 :', ageClassification(0) + '<br>') // 0
document.write('     1 :', ageClassification(1) + '<br>') // 1
document.write('    24 :', ageClassification(24) + '<br>') // 24
document.write(' 24.01 :', ageClassification(24.01) + '<br>')
document.write('    44 :', ageClassification(44) + '<br>') // 44
document.write(' 44.01 :', ageClassification(44.01) + '<br>')
document.write('    65 :', ageClassification(65) + '<br>') // 65
document.write('  65.1 :', ageClassification(65.1) + '<br>')
document.write('    75 :', ageClassification(75) + '<br>') // 75
document.write(' 75.01 :', ageClassification(75.01) + '<br>')
document.write('    90 :', ageClassification(90) + '<br>') // 90
document.write(' 90.01 :', ageClassification(90.01) + '<br>')
document.write('   122 :', ageClassification(122) + '<br>') // 122
document.write('122.01 :', ageClassification(122.01) + '<br>')
document.write('   150 :', ageClassification(150) + '<br>' + '<br>') // 150
...
function oddFn(n) {
  let j = [];
  let i = 1; // Починаємо з 1, оскільки 0 не має потрапляти в масив
...
document.write(oddFn(10) + '<br>');
document.write(oddFn(15) + '<br>');
document.write(oddFn(20) + '<br>' + '<br>');
...
console.log(callbackAdd(2, 5, cbRandom)); // цілі числа в діапазоні 2..5
console.log(callbackAdd(2, 5, cbPow)); // 32
console.log(callbackAdd(2, 5, cbAdd)); // 7
console.log(callbackAdd(2, 5, 'not a func')) // false

document.write(callbackAdd(2, 5, cbRandom) + '<br>');
document.write(callbackAdd(2, 5, cbPow) + '<br>');
document.write(callbackAdd(2, 5, cbAdd) + '<br>');
document.write(callbackAdd(2, 5, 'not a func') + '<br>')